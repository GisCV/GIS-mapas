...
var format_181224_10 = new ol.format.GeoJSON();
var features_181224_10 = format_181224_10.readFeatures(json_181224_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_181224_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_181224_10.addFeatures(features_181224_10);
var lyr_181224_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_181224_10, 
                style: style_181224_10,
                popuplayertitle: '18.12.24',
                interactive: true,
                title: '<img src="styles/legend/181224_10.png" /> 18.12.24'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_ndvi1812_1.setVisible(true);lyr_ndvi2312_2.setVisible(true);lyr_ndvi3012_3.setVisible(true);lyr_ndvi0401_4.setVisible(true);lyr_ndvi0901_5.setVisible(true);lyr_ndvi1101_6.setVisible(true);lyr_ndvi1401_7.setVisible(true);lyr_ndvi1701_8.setVisible(true);lyr_ndvi2201_9.setVisible(true);lyr_181224_10.setVisible(true);lyr_231224_11.setVisible(true);lyr_301224_12.setVisible(true);lyr_040125_13.setVisible(true);lyr_090125_14.setVisible(true);lyr_110125_15.setVisible(true);lyr_140125_16.setVisible(true);lyr_170125_17.setVisible(true);lyr_220125_18.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ndvi1812_1,lyr_ndvi2312_2,lyr_ndvi3012_3,lyr_ndvi0401_4,lyr_ndvi0901_5,lyr_ndvi1101_6,lyr_ndvi1401_7,lyr_ndvi1701_8,lyr_ndvi2201_9,lyr_181224_10,lyr_231224_11,lyr_301224_12,lyr_040125_13,lyr_090125_14,lyr_110125_15,lyr_140125_16,lyr_170125_17,lyr_220125_18];
lyr_181224_10.set('fieldAliases', {'Potrero': 'Potrero', 'has': 'has', '2024': '2024', '18.12.24_TC (kgMS/ha/d)': '18.12.24_TC (kgMS/ha/d)', '18.12.24_Disponible (kgMS/ha)': '18.12.24_Disponible (kgMS/ha)', });
...
lyr_110125_15.set('fieldAliases', {'Potrero': 'Potrero', 'has': 'has', '2024': '2024', '11.01.25_VALUE_mean': '11.01.25_VALUE_mean', '11.01.25_TC (kgMS/ha/d)': '11.01.25_TC (kgMS/ha/d)', });
...
lyr_181224_10.set('fieldImages', {'Potrero': 'TextEdit', 'has': 'TextEdit', '2024': 'TextEdit', '18.12.24_TC (kgMS/ha/d)': 'Range', '18.12.24_Disponible (kgMS/ha)': 'Range', });
...
lyr_110125_15.set('fieldImages', {'Potrero': 'TextEdit', 'has': 'TextEdit', '2024': 'TextEdit', '11.01.25_VALUE_mean': 'TextEdit', '11.01.25_TC (kgMS/ha/d)': 'Range', });
...
lyr_181224_10.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '18.12.24_TC (kgMS/ha/d)': 'header label - visible with data', '18.12.24_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_231224_11.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '23.12.24_TC (kgMS/ha/d)': 'header label - visible with data', '23.12.24_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_301224_12.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '30.12.24_TC (kgMS/ha/d)': 'header label - visible with data', '30.12.24_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_040125_13.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '04.01.25_TC (kgMS/ha/d)': 'header label - visible with data', '04.01.25_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_090125_14.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '04.01.25_V': 'no label', '04.01.25_T': 'no label', '09.01.25_TC (kgMS/ha/d)': 'header label - visible with data', '09.01.25_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_110125_15.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '11.01.25_VALUE_mean': 'header label - visible with data', '11.01.25_TC (kgMS/ha/d)': 'header label - visible with data', });
lyr_140125_16.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '11.01.25_V': 'no label', '11.01.25_T': 'no label', '14.01.25_TC (kgMS/ha/d)': 'header label - visible with data', '14.01.25_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_170125_17.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '17.01.25_TC (kgMS/ha/d)': 'header label - visible with data', '17.01.25_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_220125_18.set('fieldLabels', {'Potrero': 'header label - visible with data', 'has': 'header label - visible with data', '2024': 'header label - visible with data', '22.01.25_TC (kgMS/ha/d)': 'header label - visible with data', '22.01.25_Disponible (kgMS/ha)': 'header label - visible with data', });
lyr_220125_18.on('precompose', function(evt) {
