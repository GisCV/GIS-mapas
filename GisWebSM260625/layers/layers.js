...
var lyr_ndvi260625_11 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 26.06.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi260625_11.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var format_TC290425_12 = new ol.format.GeoJSON();
var features_TC290425_12 = format_TC290425_12.readFeatures(json_TC290425_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TC290425_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TC290425_12.addFeatures(features_TC290425_12);
var lyr_TC290425_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TC290425_12, 
                style: style_TC290425_12,
                popuplayertitle: 'TC 29.04.25',
                interactive: true,
                title: '<img src="styles/legend/TC290425_12.png" /> TC 29.04.25'
            });
var format_TC040525_13 = new ol.format.GeoJSON();
var features_TC040525_13 = format_TC040525_13.readFeatures(json_TC040525_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TC040525_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TC040525_13.addFeatures(features_TC040525_13);
var lyr_TC040525_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TC040525_13, 
                style: style_TC040525_13,
                popuplayertitle: 'TC 04.05.25',
                interactive: true,
                title: '<img src="styles/legend/TC040525_13.png" /> TC 04.05.25'
            });
...
lyr_Googlesatelite_0.setVisible(true);lyr_ndvi290425_1.setVisible(true);lyr_ndvi020525_2.setVisible(true);lyr_ndvi040525_3.setVisible(true);lyr_ndvi120525_4.setVisible(true);lyr_ndvi220525_5.setVisible(true);lyr_ndvi290525_6.setVisible(true);lyr_ndvi010625_7.setVisible(true);lyr_ndvi080625_8.setVisible(true);lyr_ndvi100625_9.setVisible(true);lyr_ndvi110625_10.setVisible(true);lyr_ndvi260625_11.setVisible(true);lyr_TC290425_12.setVisible(true);lyr_TC040525_13.setVisible(true);lyr_TC120525_14.setVisible(true);lyr_TC220525_15.setVisible(true);lyr_TC010625_16.setVisible(true);lyr_TC080625_17.setVisible(true);lyr_TC110625_18.setVisible(true);lyr_TC260625_19.setVisible(true);lyr_ResumenTCpromediokgMShad_20.setVisible(true);
var layersList = [lyr_Googlesatelite_0,lyr_ndvi290425_1,lyr_ndvi020525_2,lyr_ndvi040525_3,lyr_ndvi120525_4,lyr_ndvi220525_5,lyr_ndvi290525_6,lyr_ndvi010625_7,lyr_ndvi080625_8,lyr_ndvi100625_9,lyr_ndvi110625_10,lyr_ndvi260625_11,lyr_TC290425_12,lyr_TC040525_13,lyr_TC120525_14,lyr_TC220525_15,lyr_TC010625_16,lyr_TC080625_17,lyr_TC110625_18,lyr_TC260625_19,lyr_ResumenTCpromediokgMShad_20];
lyr_TC290425_12.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Especie': 'Recurso', 'Area': 'Area', 'pot imp_Po': 'Potrero', '29.04.25_TC (kgMS/ha/d)': '29.04.25_TC (kgMS/ha/d)', '29.04.25_Disponible (kgMS/ha)': '29.04.25_Disponible (kgMS/ha)', });
lyr_TC040525_13.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Especie': 'Recurso', 'Area': 'Area', 'pot imp_Po': 'Potrero', '02.05_TC (kgMS/ha/d)': '02.05_TC (kgMS/ha/d)', '02.05_Disponible (kgMS/ha)': '02.05_Disponible (kgMS/ha)', '04.05_TC (kgMS/ha/d)': '04.05_TC (kgMS/ha/d)', '04.05_Disponible (kgMS/ha)': '04.05_Disponible (kgMS/ha)', });
...
lyr_TC290425_12.set('fieldImages', {'id': 'TextEdit', 'Campo': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', 'pot imp_Po': 'TextEdit', '29.04.25_TC (kgMS/ha/d)': 'TextEdit', '29.04.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_TC040525_13.set('fieldImages', {'id': 'TextEdit', 'Campo': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', 'pot imp_Po': 'TextEdit', '02.05_TC (kgMS/ha/d)': 'TextEdit', '02.05_Disponible (kgMS/ha)': 'TextEdit', '04.05_TC (kgMS/ha/d)': 'TextEdit', '04.05_Disponible (kgMS/ha)': 'TextEdit', });
...
lyr_TC290425_12.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - visible with data', '29.04.25_TC (kgMS/ha/d)': 'inline label - always visible', '29.04.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_TC040525_13.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - visible with data', '02.05_TC (kgMS/ha/d)': 'inline label - always visible', '02.05_Disponible (kgMS/ha)': 'inline label - always visible', '04.05_TC (kgMS/ha/d)': 'inline label - always visible', '04.05_Disponible (kgMS/ha)': 'inline label - always visible', });
