...
var group_Oliver = new ol.layer.Group({
                                layers: [lyr_ndvi2102_1,lyr_ndvi0503_2,lyr_ndvi1003_3,lyr_ndvi1303_4,lyr_ndvi1503_5,lyr_ndvi1803_6,lyr_ndvi2003_7,lyr_ndvi3003_8,lyr_ndvi0404_9,lyr_ndvi1404_10,lyr_TC210225_11,lyr_TC050325_12,lyr_TC100325_13,lyr_TC130325_14,lyr_TC150325_15,lyr_TC180325_16,lyr_TC200325_17,lyr_TC300325_18,lyr_TC040425_19,lyr_TC140425_20,],
                                fold: "open",
                                title: 'Oliver'});
...
lyr_googlesatelite_0.setVisible(true);lyr_ndvi2102_1.setVisible(true);lyr_ndvi0503_2.setVisible(true);lyr_ndvi1003_3.setVisible(true);lyr_ndvi1303_4.setVisible(true);lyr_ndvi1503_5.setVisible(true);lyr_ndvi1803_6.setVisible(true);lyr_ndvi2003_7.setVisible(true);lyr_ndvi3003_8.setVisible(true);lyr_ndvi0404_9.setVisible(true);lyr_ndvi1404_10.setVisible(true);lyr_TC210225_11.setVisible(true);lyr_TC050325_12.setVisible(true);lyr_TC100325_13.setVisible(true);lyr_TC130325_14.setVisible(true);lyr_TC150325_15.setVisible(true);lyr_TC180325_16.setVisible(true);lyr_TC200325_17.setVisible(true);lyr_TC300325_18.setVisible(true);lyr_TC040425_19.setVisible(true);lyr_TC140425_20.setVisible(true);
var layersList = [lyr_googlesatelite_0,group_Oliver];
lyr_TC210225_11.set('fieldAliases', {'Especie': 'Especie', 'id': 'id', 'Potrero': 'Potrero', 'Campo': 'Campo', 'Area': 'Area', '21.02.25_TC (kgMS/ha/d)': '21.02.25_TC (kgMS/ha/d)', '21.02.25_Disponible (kgMS/ha)': '21.02.25_Disponible (kgMS/ha)', });
lyr_TC050325_12.set('fieldAliases', {'Especie': 'Especie', 'id': 'id', 'Potrero': 'Potrero', 'Campo': 'Campo', 'Area': 'Area', '05.03.25_TC (kgMS/ha/d)': '05.03.25_TC (kgMS/ha/d)', '05.03.25_Disponible (kgMS/ha)': '05.03.25_Disponible (kgMS/ha)', });
lyr_TC100325_13.set('fieldAliases', {'Especie': 'Especie', 'id': 'id', 'Potrero': 'Potrero', 'Campo': 'Campo', 'Area': 'Area', '10.03.25_TC (kgMS/ha/d)': '10.03.25_TC (kgMS/ha/d)', '10.03.25_Disponible (kgMS/ha)': '10.03.25_Disponible (kgMS/ha)', });
...
lyr_TC210225_11.set('fieldImages', {'Especie': 'TextEdit', 'id': 'TextEdit', 'Potrero': 'TextEdit', 'Campo': 'TextEdit', 'Area': 'TextEdit', '21.02.25_TC (kgMS/ha/d)': 'TextEdit', '21.02.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_TC050325_12.set('fieldImages', {'Especie': 'TextEdit', 'id': 'TextEdit', 'Potrero': 'TextEdit', 'Campo': 'TextEdit', 'Area': 'TextEdit', '05.03.25_TC (kgMS/ha/d)': 'TextEdit', '05.03.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_TC100325_13.set('fieldImages', {'Especie': 'TextEdit', 'id': 'TextEdit', 'Potrero': 'TextEdit', 'Campo': 'TextEdit', 'Area': 'TextEdit', '10.03.25_TC (kgMS/ha/d)': 'TextEdit', '10.03.25_Disponible (kgMS/ha)': 'TextEdit', });
...
lyr_TC210225_11.set('fieldLabels', {'Especie': 'inline label - always visible', 'id': 'hidden field', 'Potrero': 'inline label - always visible', 'Campo': 'inline label - always visible', 'Area': 'inline label - always visible', '21.02.25_TC (kgMS/ha/d)': 'inline label - always visible', '21.02.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_TC050325_12.set('fieldLabels', {'Especie': 'inline label - always visible', 'id': 'hidden field', 'Potrero': 'inline label - always visible', 'Campo': 'inline label - always visible', 'Area': 'inline label - always visible', '05.03.25_TC (kgMS/ha/d)': 'inline label - always visible', '05.03.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_TC100325_13.set('fieldLabels', {'Especie': 'inline label - always visible', 'id': 'hidden field', 'Potrero': 'inline label - always visible', 'Campo': 'inline label - always visible', 'Area': 'inline label - always visible', '10.03.25_TC (kgMS/ha/d)': 'inline label - always visible', '10.03.25_Disponible (kgMS/ha)': 'inline label - always visible', });
...
lyr_TC140425_20.on('precompose', function(evt) {
