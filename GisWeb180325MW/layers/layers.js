...
var lyr_ndvi1803MW_13 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 18.03 MW',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi1803MW_13.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6393497.334488, -3876625.262444, -6392264.798663, -3874520.472871]
                            })
                        });
...
var format_150325MW_25 = new ol.format.GeoJSON();
var features_150325MW_25 = format_150325MW_25.readFeatures(json_150325MW_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_150325MW_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_150325MW_25.addFeatures(features_150325MW_25);
var lyr_150325MW_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_150325MW_25, 
                style: style_150325MW_25,
                popuplayertitle: '15.03.25 MW',
                interactive: true,
                title: '<img src="styles/legend/150325MW_25.png" /> 15.03.25 MW'
            });
var format_180325MW_26 = new ol.format.GeoJSON();
var features_180325MW_26 = format_180325MW_26.readFeatures(json_180325MW_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_180325MW_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_180325MW_26.addFeatures(features_180325MW_26);
var lyr_180325MW_26 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_180325MW_26, 
                style: style_180325MW_26,
                popuplayertitle: '18.03.25 MW',
                interactive: true,
                title: '<img src="styles/legend/180325MW_26.png" /> 18.03.25 MW'
            });
var group_MW = new ol.layer.Group({
                                layers: [lyr_ndvi1101mw_1,lyr_ndvi1401MW_2,lyr_ndvi1701MW_3,lyr_ndvi2201MW_4,lyr_ndvi0102MW_5,lyr_ndvi0302MW_6,lyr_ndvi0802MW_7,lyr_ndvi1802MW_8,lyr_ndvi2102MW_9,lyr_ndvi0503MW_10,lyr_ndvi1003MW_11,lyr_ndvi1503MW_12,lyr_ndvi1803MW_13,lyr_110125MW_14,lyr_140125MW_15,lyr_170125MW_16,lyr_220125MW_17,lyr_010225MW_18,lyr_030225MW_19,lyr_080225MW_20,lyr_180225MW_21,lyr_210225MW_22,lyr_050325MW_23,lyr_100325MW_24,lyr_150325MW_25,lyr_180325MW_26,],
                                fold: "open",
                                title: 'M.W'});
...
lyr_googlesatelite_0.setVisible(true);lyr_ndvi1101mw_1.setVisible(true);lyr_ndvi1401MW_2.setVisible(true);lyr_ndvi1701MW_3.setVisible(true);lyr_ndvi2201MW_4.setVisible(true);lyr_ndvi0102MW_5.setVisible(true);lyr_ndvi0302MW_6.setVisible(true);lyr_ndvi0802MW_7.setVisible(true);lyr_ndvi1802MW_8.setVisible(true);lyr_ndvi2102MW_9.setVisible(true);lyr_ndvi0503MW_10.setVisible(true);lyr_ndvi1003MW_11.setVisible(true);lyr_ndvi1503MW_12.setVisible(true);lyr_ndvi1803MW_13.setVisible(true);lyr_110125MW_14.setVisible(true);lyr_140125MW_15.setVisible(true);lyr_170125MW_16.setVisible(true);lyr_220125MW_17.setVisible(true);lyr_010225MW_18.setVisible(true);lyr_030225MW_19.setVisible(true);lyr_080225MW_20.setVisible(true);lyr_180225MW_21.setVisible(true);lyr_210225MW_22.setVisible(true);lyr_050325MW_23.setVisible(true);lyr_100325MW_24.setVisible(true);lyr_150325MW_25.setVisible(true);lyr_180325MW_26.setVisible(true);
...
lyr_150325MW_25.set('fieldAliases', {'id': 'id', 'Especie': 'Especie', 'Pot': 'Pot', 'Area': 'Area', '15.03.25_TC (kgMS/ha/d)': '15.03.25_TC (kgMS/ha/d)', '15.03.25_Disponible (kgMS/ha)': '15.03.25_Disponible (kgMS/ha)', });
lyr_180325MW_26.set('fieldAliases', {'id': 'id', 'Especie': 'Especie', 'Pot': 'Pot', 'Area': 'Area', '18.03.25_TC (kgMS/ha/d)': '18.03.25_TC (kgMS/ha/d)', '18.03.25_Disponible (kgMS/ha)': '18.03.25_Disponible (kgMS/ha)', });
...
lyr_150325MW_25.set('fieldImages', {'id': 'TextEdit', 'Especie': 'TextEdit', 'Pot': 'TextEdit', 'Area': 'TextEdit', '15.03.25_TC (kgMS/ha/d)': 'TextEdit', '15.03.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_180325MW_26.set('fieldImages', {'id': 'TextEdit', 'Especie': 'TextEdit', 'Pot': 'TextEdit', 'Area': 'TextEdit', '18.03.25_TC (kgMS/ha/d)': 'TextEdit', '18.03.25_Disponible (kgMS/ha)': 'TextEdit', });
...
lyr_150325MW_25.set('fieldLabels', {'id': 'hidden field', 'Especie': 'inline label - always visible', 'Pot': 'inline label - always visible', 'Area': 'inline label - always visible', '15.03.25_TC (kgMS/ha/d)': 'inline label - always visible', '15.03.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_180325MW_26.set('fieldLabels', {'id': 'hidden field', 'Especie': 'inline label - always visible', 'Pot': 'inline label - always visible', 'Area': 'inline label - always visible', '18.03.25_TC (kgMS/ha/d)': 'inline label - always visible', '18.03.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_180325MW_26.on('precompose', function(evt) {
