...
var lyr_ndvi220125pot_9 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 22.01.25 pot',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi220125pot_9.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var format_TC3012224_12 = new ol.format.GeoJSON();
var features_TC3012224_12 = format_TC3012224_12.readFeatures(json_TC3012224_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TC3012224_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TC3012224_12.addFeatures(features_TC3012224_12);
var lyr_TC3012224_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TC3012224_12, 
                style: style_TC3012224_12,
                popuplayertitle: 'TC 30.12.224',
                interactive: true,
                title: '<img src="styles/legend/TC3012224_12.png" /> TC 30.12.224'
            });
...
lyr_Googlesatelite_0.setVisible(true);lyr_ndvi51224_1.setVisible(true);lyr_ndvi101224_2.setVisible(true);lyr_ndvi301224_3.setVisible(true);lyr_ndvi040125_4.setVisible(true);lyr_ndvi090125_5.setVisible(true);lyr_ndvi110125_6.setVisible(true);lyr_ndvi140125_7.setVisible(true);lyr_ndvi170125_8.setVisible(true);lyr_ndvi220125pot_9.setVisible(true);lyr_TC51224_10.setVisible(true);lyr_TC101224_11.setVisible(true);lyr_TC3012224_12.setVisible(true);lyr_TC040125_13.setVisible(true);lyr_TC090125_14.setVisible(true);lyr_TC110125_15.setVisible(true);lyr_TC140125_16.setVisible(true);lyr_TC170125_17.setVisible(true);lyr_TC220125_18.setVisible(true);lyr_ResumenTCpromediokgMShad_19.setVisible(true);
var layersList = [lyr_Googlesatelite_0,lyr_ndvi51224_1,lyr_ndvi101224_2,lyr_ndvi301224_3,lyr_ndvi040125_4,lyr_ndvi090125_5,lyr_ndvi110125_6,lyr_ndvi140125_7,lyr_ndvi170125_8,lyr_ndvi220125pot_9,lyr_TC51224_10,lyr_TC101224_11,lyr_TC3012224_12,lyr_TC040125_13,lyr_TC090125_14,lyr_TC110125_15,lyr_TC140125_16,lyr_TC170125_17,lyr_TC220125_18,lyr_ResumenTCpromediokgMShad_19];
lyr_TC51224_10.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Especie': 'Recurso', 'Area': 'Area', 'pot imp_Po': 'Potrero', '5.12.24_TC': '5.12.24_TC', '5.12.24_Di': '5.12.24_Di', });
lyr_TC101224_11.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Especie': 'Recurso', 'Area': 'Area', 'pot imp_Po': 'Potrero', '10.12.24_TC (kgMS/ha/d)': '10.12.24_TC (kgMS/ha/d)', '10.12.24_Disponible (kgMS/ha)': '10.12.24_Disponible (kgMS/ha)', });
lyr_TC3012224_12.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Especie': 'Recurso', 'Area': 'Area', 'pot imp_Po': 'Potrero', '30.12.24_TC (kgMS/ha/d)': '30.12.24_TC (kgMS/ha/d)', '30.12.24_Disponible (kgMS/ha)': '30.12.24_Disponible (kgMS/ha)', });
...
lyr_ResumenTCpromediokgMShad_19.set('fieldAliases', {'Cría 5.12': 'Cría 5.12', 'Recría 5.': 'Recría 5.', 'Cría 10.1': 'Cría 10.1', 'Recría 10': 'Recría 10', 'Cría 30.1': 'Cría 30.1', 'Recría301': 'Recría301', 'Cría4.1.2': 'Cría4.1.2', 'Recría4.1': 'Recría4.1', 'Cría9.1': 'Cría9.1', 'Recría9.1': 'Recría9.1', 'Cría11.1': 'Cría11.1', 'Recría11.': 'Recría11.', 'Cría14.1': 'Cría14.1', 'Recría14.': 'Recría14.', 'Cría17.01': 'Cría17.01', 'Recría17.': 'Recría17.', 'Cría22.01': 'Cría22.01', 'Recría22.': 'Recría22.', });
lyr_TC51224_10.set('fieldImages', {'id': 'TextEdit', 'Campo': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', 'pot imp_Po': 'TextEdit', '5.12.24_TC': '', '5.12.24_Di': '', });
lyr_TC101224_11.set('fieldImages', {'id': 'TextEdit', 'Campo': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', 'pot imp_Po': 'TextEdit', '10.12.24_TC (kgMS/ha/d)': 'TextEdit', '10.12.24_Disponible (kgMS/ha)': 'TextEdit', });
lyr_TC3012224_12.set('fieldImages', {'id': 'TextEdit', 'Campo': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', 'pot imp_Po': 'TextEdit', '30.12.24_TC (kgMS/ha/d)': 'TextEdit', '30.12.24_Disponible (kgMS/ha)': 'TextEdit', });
...
lyr_ResumenTCpromediokgMShad_19.set('fieldImages', {'Cría 5.12': 'TextEdit', 'Recría 5.': 'TextEdit', 'Cría 10.1': 'TextEdit', 'Recría 10': 'TextEdit', 'Cría 30.1': 'TextEdit', 'Recría301': 'TextEdit', 'Cría4.1.2': '', 'Recría4.1': '', 'Cría9.1': 'TextEdit', 'Recría9.1': 'TextEdit', 'Cría11.1': '', 'Recría11.': '', 'Cría14.1': '', 'Recría14.': '', 'Cría17.01': '', 'Recría17.': '', 'Cría22.01': '', 'Recría22.': '', });
lyr_TC51224_10.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '5.12.24_TC': 'inline label - visible with data', '5.12.24_Di': 'inline label - visible with data', });
lyr_TC101224_11.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '10.12.24_TC (kgMS/ha/d)': 'inline label - visible with data', '10.12.24_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_TC3012224_12.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '30.12.24_TC (kgMS/ha/d)': 'inline label - visible with data', '30.12.24_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_TC040125_13.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '30.12.24_T': 'hidden field', '30.12.24_D': 'hidden field', '04.01.25_TC (kgMS/ha/d)': 'inline label - visible with data', '04.01.25_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_TC090125_14.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '09.01.25_TC (kgMS/ha/d)': 'inline label - visible with data', '09.01.25_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_TC110125_15.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '11.01.25_TC (kgMS/ha/d)': 'inline label - visible with data', '11.01.25_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_TC140125_16.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '14.01.25_TC (kgMS/ha/d)': 'inline label - visible with data', '14.01.25_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_TC170125_17.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - always visible', '17.01.25_TC (kgMS/ha/d)': 'inline label - visible with data', '17.01.25_Dispnible (kgMS/ha)': 'inline label - visible with data', });
...
lyr_ResumenTCpromediokgMShad_19.set('fieldLabels', {'Cría 5.12': 'inline label - visible with data', 'Recría 5.': 'inline label - visible with data', 'Cría 10.1': 'inline label - visible with data', 'Recría 10': 'inline label - visible with data', 'Cría 30.1': 'inline label - visible with data', 'Recría301': 'inline label - visible with data', 'Cría4.1.2': 'inline label - visible with data', 'Recría4.1': 'inline label - visible with data', 'Cría9.1': 'inline label - visible with data', 'Recría9.1': 'inline label - visible with data', 'Cría11.1': 'inline label - visible with data', 'Recría11.': 'inline label - visible with data', 'Cría14.1': 'inline label - visible with data', 'Recría14.': 'inline label - visible with data', 'Cría17.01': 'inline label - visible with data', 'Recría17.': 'inline label - visible with data', 'Cría22.01': 'inline label - visible with data', 'Recría22.': 'inline label - visible with data', });
