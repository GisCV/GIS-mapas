...
var lyr_ndvi0302_11 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 03.02',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi0302_11.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6399053.419152, -3879759.467633, -6389436.968908, -3866683.610838]
...
var lyr_ndvi0802_12 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 08.02',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi0802_12.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6399053.419152, -3879759.467633, -6389436.968908, -3866683.610838]
...
var group_Oliver = new ol.layer.Group({
                                layers: [lyr_ndvi3012_1,lyr_ndvi0201_2,lyr_ndvi0401_3,lyr_ndvi0701_4,lyr_ndvi0901_5,lyr_ndvi1101_6,lyr_ndvi1401_7,lyr_ndvi1701_8,lyr_ndvi2201_9,lyr_ndvi0102_10,lyr_ndvi0302_11,lyr_ndvi0802_12,lyr_TC301224_13,lyr_TC020125_14,lyr_TC040125_15,lyr_TC070125_16,lyr_TC090125_17,lyr_TC110125_18,lyr_TC140125_19,lyr_TC170125_20,lyr_TC220125_21,lyr_TC010225_22,lyr_TC030225_23,lyr_TC080225_24,],
                                fold: "open",
                                title: 'Oliver'});

lyr_googlesatelite_0.setVisible(true);lyr_ndvi3012_1.setVisible(true);lyr_ndvi0201_2.setVisible(true);lyr_ndvi0401_3.setVisible(true);lyr_ndvi0701_4.setVisible(true);lyr_ndvi0901_5.setVisible(true);lyr_ndvi1101_6.setVisible(true);lyr_ndvi1401_7.setVisible(true);lyr_ndvi1701_8.setVisible(true);lyr_ndvi2201_9.setVisible(true);lyr_ndvi0102_10.setVisible(true);lyr_ndvi0302_11.setVisible(true);lyr_ndvi0802_12.setVisible(true);lyr_TC301224_13.setVisible(true);lyr_TC020125_14.setVisible(true);lyr_TC040125_15.setVisible(true);lyr_TC070125_16.setVisible(true);lyr_TC090125_17.setVisible(true);lyr_TC110125_18.setVisible(true);lyr_TC140125_19.setVisible(true);lyr_TC170125_20.setVisible(true);lyr_TC220125_21.setVisible(true);lyr_TC010225_22.setVisible(true);lyr_TC030225_23.setVisible(true);lyr_TC080225_24.setVisible(true);
...
lyr_TC030225_23.set('fieldAliases', {'Especie': 'Especie', 'id': 'id', 'Potrero': 'Potrero', 'Campo': 'Campo', 'Area': 'Area', '03.02.25_TC (kgMS/ha/d)': '03.02.25_TC (kgMS/ha/d)', '03.02.25_Disponible (kgMS/ha)': '03.02.25_Disponible (kgMS/ha)', });
lyr_TC080225_24.set('fieldAliases', {'Especie': 'Especie', 'id': 'id', 'Potrero': 'Potrero', 'Campo': 'Campo', 'Area': 'Area', '08.02.25_TC (kgMS/ha/d)': '08.02.25_TC (kgMS/ha/d)', '08.02.25_Disponible (kgMS/ha)': '08.02.25_Disponible (kgMS/ha)', });
...
lyr_TC030225_23.set('fieldImages', {'Especie': 'TextEdit', 'id': 'TextEdit', 'Potrero': 'TextEdit', 'Campo': 'TextEdit', 'Area': 'TextEdit', '03.02.25_TC (kgMS/ha/d)': 'TextEdit', '03.02.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_TC080225_24.set('fieldImages', {'Especie': 'TextEdit', 'id': 'TextEdit', 'Potrero': 'TextEdit', 'Campo': 'TextEdit', 'Area': 'TextEdit', '08.02.25_TC (kgMS/ha/d)': 'TextEdit', '08.02.25_Disponible (kgMS/ha)': 'TextEdit', });
...
lyr_TC030225_23.set('fieldLabels', {'Especie': 'inline label - always visible', 'id': 'hidden field', 'Potrero': 'inline label - always visible', 'Campo': 'inline label - always visible', 'Area': 'inline label - always visible', '03.02.25_TC (kgMS/ha/d)': 'inline label - always visible', '03.02.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_TC080225_24.set('fieldLabels', {'Especie': 'inline label - always visible', 'id': 'hidden field', 'Potrero': 'inline label - always visible', 'Campo': 'inline label - always visible', 'Area': 'inline label - always visible', '08.02.25_TC (kgMS/ha/d)': 'inline label - always visible', '08.02.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_TC080225_24.on('precompose', function(evt) {
