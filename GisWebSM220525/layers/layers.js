...
var lyr_ndvi220525_10 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 22.05.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi220525_10.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var format_TC220525_19 = new ol.format.GeoJSON();
var features_TC220525_19 = format_TC220525_19.readFeatures(json_TC220525_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TC220525_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TC220525_19.addFeatures(features_TC220525_19);
var lyr_TC220525_19 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TC220525_19, 
                style: style_TC220525_19,
                popuplayertitle: 'TC 22.05.25',
                interactive: true,
                title: '<img src="styles/legend/TC220525_19.png" /> TC 22.05.25'
            });
...
lyr_TC220525_19.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Especie': 'Recurso', 'Area': 'Area', 'pot imp_Po': 'Potrero', '22.05.25_TC (kgMS/ha/d)': '22.05.25_TC (kgMS/ha/d)', '22.05.25_Disponible (kgMS/ha)': '22.05.25_Disponible (kgMS/ha)', });
lyr_ResumenTCpromediokgMShad_20.set('fieldAliases', {'SemanaCrí': 'SemanaCrí', 'SemanaRecr': 'SemanaRecr', 'MarzoCr�': 'MarzoCr�', 'MarzoRec': 'MarzoRec', });
...
lyr_TC220525_19.set('fieldImages', {'id': 'TextEdit', 'Campo': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', 'pot imp_Po': 'TextEdit', '22.05.25_TC (kgMS/ha/d)': 'TextEdit', '22.05.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_ResumenTCpromediokgMShad_20.set('fieldImages', {'SemanaCrí': 'TextEdit', 'SemanaRecr': 'TextEdit', 'MarzoCr�': '', 'MarzoRec': '', });
...
lyr_TC220525_19.set('fieldLabels', {'id': 'hidden field', 'Campo': 'inline label - always visible', 'Especie': 'inline label - always visible', 'Area': 'inline label - always visible', 'pot imp_Po': 'inline label - visible with data', '22.05.25_TC (kgMS/ha/d)': 'inline label - always visible', '22.05.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_ResumenTCpromediokgMShad_20.set('fieldLabels', {'SemanaCrí': 'inline label - always visible', 'SemanaRecr': 'inline label - always visible', 'MarzoCr�': 'inline label - always visible', 'MarzoRec': 'inline label - always visible', });
