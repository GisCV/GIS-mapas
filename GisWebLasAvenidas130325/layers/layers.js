...
var lyr_ndvi030325_11 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 03.03.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi030325_11.png",
                                attributions: ' ',
                                projection: 'EPSG:32721',
                                alwaysInRange: true,
                                imageExtent: [410787.682700, 6432345.002700, 414372.066100, 6435674.934900]
...
var lyr_ndvi130325_12 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 13.03.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi130325_12.png",
                                attributions: ' ',
                                projection: 'EPSG:32721',
                                alwaysInRange: true,
                                imageExtent: [410787.682700, 6432345.002700, 414372.066100, 6435674.934900]
...
lyr_010225_22.set('fieldLabels', {'Name': 'inline label - always visible', 'Especie': 'inline label - always visible', 'ha': 'inline label - visible with data', '01.02.25_TC (kgMS/ha/d)': 'inline label - always visible', '01.02.25_Disponible (kgMS/ha)': 'inline label - always visible', });
...
lyr_130325_24.on('precompose', function(evt) {
