...
var lyr_ndvi1802HS_13 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 18.02 HS',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi1802HS_13.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6397617.010243, -3876803.113215, -6395370.113178, -3875069.250742]
...
var format_080225HS_25 = new ol.format.GeoJSON();
var features_080225HS_25 = format_080225HS_25.readFeatures(json_080225HS_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_080225HS_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_080225HS_25.addFeatures(features_080225HS_25);
var lyr_080225HS_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_080225HS_25, 
                style: style_080225HS_25,
                popuplayertitle: '08.02.25 HS',
                interactive: true,
                title: '<img src="styles/legend/080225HS_25.png" /> 08.02.25 HS'
            });
var format_180225HS_26 = new ol.format.GeoJSON();
var features_180225HS_26 = format_180225HS_26.readFeatures(json_180225HS_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_180225HS_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_180225HS_26.addFeatures(features_180225HS_26);
var lyr_180225HS_26 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_180225HS_26, 
                style: style_180225HS_26,
                popuplayertitle: '18.02.25 HS',
                interactive: true,
                title: '<img src="styles/legend/180225HS_26.png" /> 18.02.25 HS'
            });
var group_HS = new ol.layer.Group({
                                layers: [lyr_ndvi3012hs_1,lyr_ndvi0201hs_2,lyr_ndvi0401hs_3,lyr_ndvi0701hs_4,lyr_ndvi0901hs_5,lyr_ndvi1101HS_6,lyr_ndvi1401hs_7,lyr_ndvi1701hs_8,lyr_ndvi2201HS_9,lyr_ndvi0102HS_10,lyr_ndvi0302HS_11,lyr_ndvi0802HS_12,lyr_ndvi1802HS_13,lyr_301224HS_14,lyr_020125HS_15,lyr_040125HS_16,lyr_070125HS_17,lyr_090125HS_18,lyr_110125HS_19,lyr_140125HS_20,lyr_170125HS_21,lyr_220125HS_22,lyr_010225HS_23,lyr_030225HS_24,lyr_080225HS_25,lyr_180225HS_26,],
                                fold: "open",
                                title: 'H.S'});
...
lyr_googlesatelite_0.setVisible(true);lyr_ndvi3012hs_1.setVisible(true);lyr_ndvi0201hs_2.setVisible(true);lyr_ndvi0401hs_3.setVisible(true);lyr_ndvi0701hs_4.setVisible(true);lyr_ndvi0901hs_5.setVisible(true);lyr_ndvi1101HS_6.setVisible(true);lyr_ndvi1401hs_7.setVisible(true);lyr_ndvi1701hs_8.setVisible(true);lyr_ndvi2201HS_9.setVisible(true);lyr_ndvi0102HS_10.setVisible(true);lyr_ndvi0302HS_11.setVisible(true);lyr_ndvi0802HS_12.setVisible(true);lyr_ndvi1802HS_13.setVisible(true);lyr_301224HS_14.setVisible(true);lyr_020125HS_15.setVisible(true);lyr_040125HS_16.setVisible(true);lyr_070125HS_17.setVisible(true);lyr_090125HS_18.setVisible(true);lyr_110125HS_19.setVisible(true);lyr_140125HS_20.setVisible(true);lyr_170125HS_21.setVisible(true);lyr_220125HS_22.setVisible(true);lyr_010225HS_23.setVisible(true);lyr_030225HS_24.setVisible(true);lyr_080225HS_25.setVisible(true);lyr_180225HS_26.setVisible(true);
...
lyr_080225HS_25.set('fieldAliases', {'id': 'id', 'Potrero': 'Potrero', 'Especie': 'Especie', 'Area': 'Area', '08.02.25_TC (kgMS/ha/d)': '08.02.25_TC (kgMS/ha/d)', '08.02.25_Disponible (KgMS/ha)': '08.02.25_Disponible (KgMS/ha)', });
lyr_180225HS_26.set('fieldAliases', {'id': 'id', 'Potrero': 'Potrero', 'Especie': 'Especie', 'Area': 'Area', '18.02.25_TC (kgMS/ha/d)': '18.02.25_TC (kgMS/ha/d)', '18.02.25_Disponible (KgMS/ha)': '18.02.25_Disponible (KgMS/ha)', });
...
lyr_080225HS_25.set('fieldImages', {'id': 'TextEdit', 'Potrero': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', '08.02.25_TC (kgMS/ha/d)': 'TextEdit', '08.02.25_Disponible (KgMS/ha)': 'TextEdit', });
lyr_180225HS_26.set('fieldImages', {'id': 'TextEdit', 'Potrero': 'TextEdit', 'Especie': 'TextEdit', 'Area': 'TextEdit', '18.02.25_TC (kgMS/ha/d)': 'TextEdit', '18.02.25_Disponible (KgMS/ha)': 'TextEdit', });
...
lyr_080225HS_25.set('fieldLabels', {'id': 'hidden field', 'Potrero': 'inline label - visible with data', 'Especie': 'inline label - visible with data', 'Area': 'inline label - visible with data', '08.02.25_TC (kgMS/ha/d)': 'inline label - always visible', '08.02.25_Disponible (KgMS/ha)': 'inline label - always visible', });
lyr_180225HS_26.set('fieldLabels', {'id': 'hidden field', 'Potrero': 'inline label - visible with data', 'Especie': 'inline label - visible with data', 'Area': 'inline label - visible with data', '18.02.25_TC (kgMS/ha/d)': 'inline label - always visible', '18.02.25_Disponible (KgMS/ha)': 'inline label - always visible', });
lyr_180225HS_26.on('precompose', function(evt) {
