...
var lyr_ndvi0901MW_4 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 09.01 MW',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi0901MW_4.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6393498.532075, -3876641.113269, -6392256.183595, -3874502.185161]
...
var lyr_ndvi0401MW_6 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 04.01 MW',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi0401MW_6.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6393498.532075, -3876641.113269, -6392256.183595, -3874502.185161]
...
var lyr_ndvi0201MW_7 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 02.01 MW',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi0201MW_7.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6393498.532075, -3876641.113269, -6392256.183595, -3874502.185161]
...
var lyr_ndvi3012MW_8 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 30.12 MW',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi3012MW_8.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6393498.532075, -3876641.113269, -6392256.183595, -3874502.185161]
...
var lyr_ndvi2312MW_9 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 23.12 MW',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi2312MW_9.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6393498.532075, -3876641.113269, -6392256.183595, -3874502.185161]
...
var format_181224MW_22 = new ol.format.GeoJSON();
var features_181224MW_22 = format_181224MW_22.readFeatures(json_181224MW_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_181224MW_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_181224MW_22.addFeatures(features_181224MW_22);
var lyr_181224MW_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_181224MW_22, 
                style: style_181224MW_22,
                popuplayertitle: '18.12.24 MW',
                interactive: true,
                title: '<img src="styles/legend/181224MW_22.png" /> 18.12.24 MW'
            });
var format_101224MW_23 = new ol.format.GeoJSON();
var features_101224MW_23 = format_101224MW_23.readFeatures(json_101224MW_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_101224MW_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_101224MW_23.addFeatures(features_101224MW_23);
var lyr_101224MW_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_101224MW_23, 
                style: style_101224MW_23,
                popuplayertitle: '10.12.24 MW',
                interactive: true,
                title: '<img src="styles/legend/101224MW_23.png" /> 10.12.24 MW'
            });
var format_51224MW_24 = new ol.format.GeoJSON();
var features_51224MW_24 = format_51224MW_24.readFeatures(json_51224MW_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_51224MW_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_51224MW_24.addFeatures(features_51224MW_24);
var lyr_51224MW_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_51224MW_24, 
                style: style_51224MW_24,
                popuplayertitle: '5.12.24 MW',
                interactive: true,
                title: '<img src="styles/legend/51224MW_24.png" /> 5.12.24 MW'
            });
var group_MW = new ol.layer.Group({
                                layers: [lyr_ndvi1701MW_1,lyr_ndvi1401MW_2,lyr_ndvi1101mw_3,lyr_ndvi0901MW_4,lyr_ndvi0701MW_5,lyr_ndvi0401MW_6,lyr_ndvi0201MW_7,lyr_ndvi3012MW_8,lyr_ndvi2312MW_9,lyr_ndvi1812mw_10,lyr_ndvi1012mw_11,lyr_ndvi51224_12,lyr_170125MW_13,lyr_140125MW_14,lyr_110125MW_15,lyr_090125MW_16,lyr_070125MW_17,lyr_040125MW_18,lyr_020125MW_19,lyr_301224MW_20,lyr_231224MW_21,lyr_181224MW_22,lyr_101224MW_23,lyr_51224MW_24,],
                                fold: "open",
                                title: 'M.W'});

lyr_googlesatelite_0.setVisible(true);lyr_ndvi1701MW_1.setVisible(true);lyr_ndvi1401MW_2.setVisible(true);lyr_ndvi1101mw_3.setVisible(true);lyr_ndvi0901MW_4.setVisible(true);lyr_ndvi0701MW_5.setVisible(true);lyr_ndvi0401MW_6.setVisible(true);lyr_ndvi0201MW_7.setVisible(true);lyr_ndvi3012MW_8.setVisible(true);lyr_ndvi2312MW_9.setVisible(true);lyr_ndvi1812mw_10.setVisible(true);lyr_ndvi1012mw_11.setVisible(true);lyr_ndvi51224_12.setVisible(true);lyr_170125MW_13.setVisible(true);lyr_140125MW_14.setVisible(true);lyr_110125MW_15.setVisible(true);lyr_090125MW_16.setVisible(true);lyr_070125MW_17.setVisible(true);lyr_040125MW_18.setVisible(true);lyr_020125MW_19.setVisible(true);lyr_301224MW_20.setVisible(true);lyr_231224MW_21.setVisible(true);lyr_181224MW_22.setVisible(true);lyr_101224MW_23.setVisible(true);lyr_51224MW_24.setVisible(true);
...
lyr_181224MW_22.set('fieldAliases', {'id': 'id', 'Especie': 'Especie', 'Pot': 'Pot', 'Area': 'Area', '18.12.24_(kgMS/ha/d)': '18.12.24_(kgMS/ha/d)', '18.12.24_Disponible (kgMS/ha)': '18.12.24_Disponible (kgMS/ha)', });
lyr_101224MW_23.set('fieldAliases', {'id': 'id', 'Especie': 'Especie', 'Pot': 'Pot', 'Area': 'Area', '10.12.24_TC (kgMS/ha/d)': '10.12.24_TC (kgMS/ha/d)', '10.12.24_Disponible (kgMS/ha)': '10.12.24_Disponible (kgMS/ha)', });
lyr_51224MW_24.set('fieldAliases', {'id': 'id', 'Especie': 'Especie', 'Pot': 'Pot', 'Area': 'Area', '5.12.24_TC': '5.12.24_TC', '5.12.24_Di': '5.12.24_Di', });
...
lyr_181224MW_22.set('fieldImages', {'id': 'TextEdit', 'Especie': 'TextEdit', 'Pot': 'TextEdit', 'Area': 'TextEdit', '18.12.24_(kgMS/ha/d)': 'TextEdit', '18.12.24_Disponible (kgMS/ha)': 'TextEdit', });
lyr_101224MW_23.set('fieldImages', {'id': 'TextEdit', 'Especie': 'TextEdit', 'Pot': 'TextEdit', 'Area': 'TextEdit', '10.12.24_TC (kgMS/ha/d)': 'TextEdit', '10.12.24_Disponible (kgMS/ha)': 'TextEdit', });
lyr_51224MW_24.set('fieldImages', {'id': 'TextEdit', 'Especie': 'TextEdit', 'Pot': 'TextEdit', 'Area': 'TextEdit', '5.12.24_TC': '', '5.12.24_Di': '', });
...
lyr_181224MW_22.set('fieldLabels', {'id': 'hidden field', 'Especie': 'header label - visible with data', 'Pot': 'header label - always visible', 'Area': 'header label - always visible', '18.12.24_(kgMS/ha/d)': 'inline label - visible with data', '18.12.24_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_101224MW_23.set('fieldLabels', {'id': 'hidden field', 'Especie': 'header label - visible with data', 'Pot': 'header label - always visible', 'Area': 'header label - always visible', '10.12.24_TC (kgMS/ha/d)': 'inline label - visible with data', '10.12.24_Disponible (kgMS/ha)': 'inline label - visible with data', });
lyr_51224MW_24.set('fieldLabels', {'id': 'hidden field', 'Especie': 'header label - visible with data', 'Pot': 'header label - always visible', 'Area': 'header label - always visible', '5.12.24_TC': 'inline label - visible with data', '5.12.24_Di': 'inline label - visible with data', });
lyr_51224MW_24.on('precompose', function(evt) {
