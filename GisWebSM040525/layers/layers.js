...
var lyr_ndvi200325_1 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 20.03.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi200325_1.png",
                                attributions: ' ',
...
var lyr_ndvi300325_2 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 30.03.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi300325_2.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi140425_3 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 14.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi140425_3.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi170425_4 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 17.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi170425_4.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi190425_5 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 19.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi190425_5.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi220425_6 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 22.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi220425_6.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi290425_7 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 29.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi290425_7.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi020525_8 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 02.05.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi020525_8.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
var lyr_ndvi040525_9 = new ol.layer.Image({
                            opacity: 1,
                            title: 'ndvi 04.05.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/ndvi040525_9.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6419462.220277, -3963752.751085, -6408238.732155, -3947115.193257]
...
lyr_Googlesatelite_0.setVisible(true);lyr_ndvi200325_1.setVisible(true);lyr_ndvi300325_2.setVisible(true);lyr_ndvi140425_3.setVisible(true);lyr_ndvi170425_4.setVisible(true);lyr_ndvi190425_5.setVisible(true);lyr_ndvi220425_6.setVisible(true);lyr_ndvi290425_7.setVisible(true);lyr_ndvi020525_8.setVisible(true);lyr_ndvi040525_9.setVisible(true);lyr_TC200325_10.setVisible(true);lyr_TC300325_11.setVisible(true);lyr_TC140425_12.setVisible(true);lyr_TC170425_13.setVisible(true);lyr_TC190425_14.setVisible(true);lyr_TC220425_15.setVisible(true);lyr_TC290425_16.setVisible(true);lyr_TC040525_17.setVisible(true);lyr_ResumenTCpromediokgMShad_18.setVisible(true);
var layersList = [lyr_Googlesatelite_0,lyr_ndvi200325_1,lyr_ndvi300325_2,lyr_ndvi140425_3,lyr_ndvi170425_4,lyr_ndvi190425_5,lyr_ndvi220425_6,lyr_ndvi290425_7,lyr_ndvi020525_8,lyr_ndvi040525_9,lyr_TC200325_10,lyr_TC300325_11,lyr_TC140425_12,lyr_TC170425_13,lyr_TC190425_14,lyr_TC220425_15,lyr_TC290425_16,lyr_TC040525_17,lyr_ResumenTCpromediokgMShad_18];
...
lyr_ResumenTCpromediokgMShad_18.set('fieldAliases', {'SemanaCrí': 'SemanaCrí', 'SemanaRecr': 'SemanaRecr', 'MarzoCr�': 'MarzoCr�', 'MarzoRec': 'MarzoRec', });
...
lyr_ResumenTCpromediokgMShad_18.set('fieldImages', {'SemanaCrí': 'TextEdit', 'SemanaRecr': 'TextEdit', 'MarzoCr�': '', 'MarzoRec': '', });
...
lyr_ResumenTCpromediokgMShad_18.set('fieldLabels', {'SemanaCrí': 'inline label - always visible', 'SemanaRecr': 'inline label - always visible', 'MarzoCr�': 'inline label - always visible', 'MarzoRec': 'inline label - always visible', });
