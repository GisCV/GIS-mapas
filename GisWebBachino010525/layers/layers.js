...
var lyr_31024_1 = new ol.layer.Image({
                            opacity: 1,
                            title: '3.10.24',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/31024_1.png",
                                attributions: ' ',
...
var lyr_281024_2 = new ol.layer.Image({
                            opacity: 1,
                            title: '28.10.24',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/281024_2.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_221224_3 = new ol.layer.Image({
                            opacity: 1,
                            title: '22.12.24',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/221224_3.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_10225_4 = new ol.layer.Image({
                            opacity: 1,
                            title: '10.2.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/10225_4.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_200225_5 = new ol.layer.Image({
                            opacity: 1,
                            title: '20.02.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/200225_5.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_250225_6 = new ol.layer.Image({
                            opacity: 1,
                            title: '25.02.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/250225_6.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_070325_7 = new ol.layer.Image({
                            opacity: 1,
                            title: '07.03.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/070325_7.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_010425_8 = new ol.layer.Image({
                            opacity: 1,
                            title: '01.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/010425_8.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_160425_9 = new ol.layer.Image({
                            opacity: 1,
                            title: '16.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/160425_9.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_210425_10 = new ol.layer.Image({
                            opacity: 1,
                            title: '21.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/210425_10.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_280425_11 = new ol.layer.Image({
                            opacity: 1,
                            title: '28.04.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/280425_11.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var lyr_010525_12 = new ol.layer.Image({
                            opacity: 1,
                            title: '01.05.25',
                            
                            
                            source: new ol.source.ImageStatic({
                                url: "./layers/010525_12.png",
                                attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-6031019.077917, -3967210.496013, -6024371.967255, -3962839.768763]
...
var format_280425_23 = new ol.format.GeoJSON();
var features_280425_23 = format_280425_23.readFeatures(json_280425_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_280425_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_280425_23.addFeatures(features_280425_23);
var lyr_280425_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_280425_23, 
                style: style_280425_23,
                popuplayertitle: '28.04.25',
                interactive: true,
                title: '<img src="styles/legend/280425_23.png" /> 28.04.25'
            });
var format_010525_24 = new ol.format.GeoJSON();
var features_010525_24 = format_010525_24.readFeatures(json_010525_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_010525_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_010525_24.addFeatures(features_010525_24);
var lyr_010525_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_010525_24, 
                style: style_010525_24,
                popuplayertitle: '01.05.25',
                interactive: true,
                title: '<img src="styles/legend/010525_24.png" /> 01.05.25'
            });
...
lyr_GoogleHybrid_0.setVisible(true);lyr_31024_1.setVisible(true);lyr_281024_2.setVisible(true);lyr_221224_3.setVisible(true);lyr_10225_4.setVisible(true);lyr_200225_5.setVisible(true);lyr_250225_6.setVisible(true);lyr_070325_7.setVisible(true);lyr_010425_8.setVisible(true);lyr_160425_9.setVisible(true);lyr_210425_10.setVisible(true);lyr_280425_11.setVisible(true);lyr_010525_12.setVisible(true);lyr_31024_13.setVisible(true);lyr_281024_14.setVisible(true);lyr_221224_15.setVisible(true);lyr_10225_16.setVisible(true);lyr_200225_17.setVisible(true);lyr_250225_18.setVisible(true);lyr_070325_19.setVisible(true);lyr_010425_20.setVisible(true);lyr_160425_21.setVisible(true);lyr_210425_22.setVisible(true);lyr_280425_23.setVisible(true);lyr_010525_24.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_31024_1,lyr_281024_2,lyr_221224_3,lyr_10225_4,lyr_200225_5,lyr_250225_6,lyr_070325_7,lyr_010425_8,lyr_160425_9,lyr_210425_10,lyr_280425_11,lyr_010525_12,lyr_31024_13,lyr_281024_14,lyr_221224_15,lyr_10225_16,lyr_200225_17,lyr_250225_18,lyr_070325_19,lyr_010425_20,lyr_160425_21,lyr_210425_22,lyr_280425_23,lyr_010525_24];
...
lyr_280425_23.set('fieldAliases', {'Recurso': 'Recurso', 'MODULO': 'MODULO', 'Siembra': 'Siembra', 'Potrero': 'Potrero', 'Id': 'Id', '28.04.25_TC (kgMS/ha/d)': '28.04.25_TC (kgMS/ha/d)', '28.04.25_Disponible (kgMS/ha)': '28.04.25_Disponible (kgMS/ha)', });
lyr_010525_24.set('fieldAliases', {'Recurso': 'Recurso', 'MODULO': 'MODULO', 'Siembra': 'Siembra', 'Potrero': 'Potrero', 'Id': 'Id', '01.05.25_TC (kgMS/ha/d)': '01.05.25_TC (kgMS/ha/d)', '01.05.25_Disponible (kgMS/ha)': '01.05.25_Disponible (kgMS/ha)', });
...
lyr_280425_23.set('fieldImages', {'Recurso': 'TextEdit', 'MODULO': 'TextEdit', 'Siembra': 'TextEdit', 'Potrero': 'TextEdit', 'Id': 'TextEdit', '28.04.25_TC (kgMS/ha/d)': 'TextEdit', '28.04.25_Disponible (kgMS/ha)': 'TextEdit', });
lyr_010525_24.set('fieldImages', {'Recurso': 'TextEdit', 'MODULO': 'TextEdit', 'Siembra': 'TextEdit', 'Potrero': 'TextEdit', 'Id': 'TextEdit', '01.05.25_TC (kgMS/ha/d)': 'TextEdit', '01.05.25_Disponible (kgMS/ha)': 'TextEdit', });
...
lyr_280425_23.set('fieldLabels', {'Recurso': 'inline label - always visible', 'MODULO': 'inline label - always visible', 'Siembra': 'hidden field', 'Potrero': 'inline label - always visible', 'Id': 'hidden field', '28.04.25_TC (kgMS/ha/d)': 'inline label - always visible', '28.04.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_010525_24.set('fieldLabels', {'Recurso': 'inline label - always visible', 'MODULO': 'inline label - always visible', 'Siembra': 'hidden field', 'Potrero': 'inline label - always visible', 'Id': 'hidden field', '01.05.25_TC (kgMS/ha/d)': 'inline label - always visible', '01.05.25_Disponible (kgMS/ha)': 'inline label - always visible', });
lyr_010525_24.on('precompose', function(evt) {
